...
import in.nit.hc.view.SpecializationPdfViews;
...
public class SpecializationController {
	...
	@GetMapping("/edit")
	public String showEditpage(@RequestParam(value = "id", required = true) Long id, Model model, RedirectAttributes attributes){
	...
	public ModelAndView exportToPdf() {
		...
		mnv.setView(new SpecializationPdfViews());
	...
	{
		Page<Specialization> page = specService.getAllSpecializations(pageable);
		model.addAttribute("specList", page.getContent());
