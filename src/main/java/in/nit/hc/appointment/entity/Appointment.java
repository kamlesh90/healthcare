package in.nit.hc.appointment.entity;
...
public class Appointment {
	...
	@DateTimeFormat(iso = ISO.DATE)   // @DataTimeFormate -> convert the string format date which we enter in UI that is Sting format to util.Date format > AND < iso is an enum used for save date only there is more option like DateTiem etc... 
